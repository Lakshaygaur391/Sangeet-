        ...
        <div className="mx-auto flex w-full max-w-md flex-col justify-center lg:mx-0 lg:max-w-none">
          ...
          <div className="mt-4 flex items-center justify-center gap-2 sm:gap-4 text-xl sm:text-2xl">
            <button
              ...
              className={`flex h-10 w-10 shrink-0 aspect-square items-center justify-center rounded-full transition hover:bg-white/10 ${
            ...
            <button
              ...
              className="flex h-10 w-10 shrink-0 aspect-square items-center justify-center rounded-full text-white/80 transition hover:bg-white/10 hover:text-white active:scale-90"
              title="Previous"
            >
            ...
            <button
              ...
              onClick={cycleRepeat}
              className={`relative flex h-10 w-10 shrink-0 aspect-square items-center justify-center rounded-full transition hover:bg-white/10 ${
