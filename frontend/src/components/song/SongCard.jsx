          ...
          <div className="flex items-center gap-1">
            ...
            <div className="relative" ref={menuRef}>
              ...
              {menuOpen && (
                <div
                  role="menu"
                  className="animate-scale-in absolute right-0 bottom-full mb-1.5 z-50 w-44 overflow-hidden rounded-xl border border-white/15 bg-[#1a1a1c]/98 py-1 shadow-2xl shadow-black/90 backdrop-blur-2xl"
                >
                  <button
                    role="menuitem"
                    type="button"
                    onClick={handleAddToQueue}
                    className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs font-semibold text-white/85 transition hover:bg-white/[0.08] hover:text-amber-300"
                  >
                    <IoListOutline className="text-base text-amber-400 shrink-0" />
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs font-semibold text-white/85 transition hover:bg-white/[0.08] hover:text-amber-300"
                  >
                    <IoPlaySkipForwardOutline className="text-base text-amber-400 shrink-0" />
