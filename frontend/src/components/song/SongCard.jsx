  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square w-full rounded-lg bg-[#18181b] shadow-[0_8px_24px_rgba(0,0,0,0.5)]">
        ...
        {/* Top-Right Quick Action Buttons (Like & More Options) — hidden on mobile, hover on desktop */}
        <div
          className={`absolute top-2 right-2 z-30 hidden sm:flex items-center gap-1.5 transition-all duration-200 ${
            liked || menuOpen
              ? "opacity-100"
